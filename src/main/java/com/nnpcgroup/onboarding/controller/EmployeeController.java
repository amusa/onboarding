...
import com.nnpcgroup.onboarding.entity.Employee;
...
import com.nnpcgroup.onboarding.ejb.EmployeeFacade;
...
public class EmployeeController implements Serializable {
    ...
    @EJB
    private com.nnpcgroup.onboarding.ejb.EmployeeFacade ejbFacade;
    ...
    public void setPersArea(PersonnelArea persArea) {
        this.persArea = persArea;
    }

    public List<PersonnelSubarea> getPersSubareaSelectOne() {

        return (persArea != null) ? persArea.getPersonnelSubareaList() : null;
    }

    public List<State> getStateSelectOne() {
        if (selected != null & selected.getCountry() != null) {

            return selected.getCountry().getStateList();
    ...
    public void persAreaValueChanged(ValueChangeEvent event) {
        System.out.println("Value Changed: " + event.getNewValue());
        SelectOneMenu so = (SelectOneMenu) event.getSource();
        PersonnelArea pa = (PersonnelArea) so.getValue();
        System.out.println("Object: " + pa.getId() + " " + pa.getDescription());
    }
